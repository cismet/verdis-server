...
public final class FlaechePropertyConstants extends PropertyConstants {
    ...
    public static final String FLAECHENBEZEICHNUNG = "flaechenbezeichnung";
    public static final String ANTEIL = "anteil";
    public static final String DATUM_AENDERUNG = "datum_erfassung";
    ...
    /**
     * Creates a new FlaechePropertyConstants object.
     */
    FlaechePropertyConstants() {
    }
}
