...
public final class BefreiungerlaubnisPropertyConstants extends PropertyConstants {
    ...
    public static final String ANTRAG_VOM = "antrag_vom";
    public static final String NUTZUNG = "nutzung";
    public static final String GEOMETRIEN = "geometrien";

    //~ Constructors -----------------------------------------------------------

    /**
     * Creates a new BefreiungerlaubnisPropertyConstants object.
     */
    BefreiungerlaubnisPropertyConstants() {
    }
}
