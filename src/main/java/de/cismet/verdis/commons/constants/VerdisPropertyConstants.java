...
public final class VerdisPropertyConstants {
    ...
    public static final ArbeitspaketEintragPropertyConstants ARBEITSPAKET_EINTRAG =
        new ArbeitspaketEintragPropertyConstants();
    public static final BefreiungerlaubnisPropertyConstants BEFREIUNGERLAUBNIS =
        new BefreiungerlaubnisPropertyConstants();
    public static final BefreiungerlaubnisGeometriePropertyConstants BEFREIUNGERLAUBNIS_GEOMETRIE =
        new BefreiungerlaubnisGeometriePropertyConstants();
    public static final BefreiungerlaubnisGeometrieTypEinleitungPropertyConstants
        BEFREIUNGERLAUBNIS_GEOMETRIE_TYP_EINLEITUNG = new BefreiungerlaubnisGeometrieTypEinleitungPropertyConstants();
    public static final BefreiungerlaubnisGeometrieTypVersickerungPropertyConstants
        BEFREIUNGERLAUBNIS_GEOMETRIE_TYP_VERSICKERUNG =
            new BefreiungerlaubnisGeometrieTypVersickerungPropertyConstants();
    public static final BefreiungerlaubnisNutzungPropertyConstants BEFREIUNGERLAUBNIS_NUTZUNG =
        new BefreiungerlaubnisNutzungPropertyConstants();
    ...
    public static final KassenzeichenGeometriePropertyConstants KASSENZEICHEN_GEOMETRIE =
        new KassenzeichenGeometriePropertyConstants();
    public static final KassenzeichenGeometrienPropertyConstants KASSENZEICHEN_GEOMETRIEN =
        new KassenzeichenGeometrienPropertyConstants();
    ...
    public static final VeranlagungseintragPropertyConstants VERANLAGUNGSEINTRAG =
        new VeranlagungseintragPropertyConstants();
    public static final VeranlagungsgrundlagePropertyConstants VERANLAGUNGSGRUNDLAGE =
        new VeranlagungsgrundlagePropertyConstants();
    public static final VeranlagungsnummerPropertyConstants VERANLAGUNGSNUMMER =
        new VeranlagungsnummerPropertyConstants();
    public static final VeranlagungspostenPropertyConstants VERANLAGUNGSPOSTEN =
        new VeranlagungspostenPropertyConstants();

    //~ Constructors -----------------------------------------------------------

    /**
     * Creates a new VerdisPropertyConstants object.
     */
    VerdisPropertyConstants() {
    }
}
