...
public final class VeranlagungseintragPropertyConstants extends PropertyConstants {
    ...
    public static final String POSTEN = "posten";
    public static final String IST_VERANLAGT = "ist_veranlagt";

    //~ Constructors -----------------------------------------------------------

    /**
     * Creates a new VeranlagungseintragPropertyConstants object.
     */
    VeranlagungseintragPropertyConstants() {
    }
}
